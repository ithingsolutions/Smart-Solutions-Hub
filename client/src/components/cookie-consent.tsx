        ...
        >
          <div className="max-w-4xl mx-auto bg-card/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-6">
                ...
                {showPreferences && (
                  ...
                  >
                    <div className="mt-6 pt-6 border-t border-border/50 space-y-4">
                      <div className={`flex items-center justify-between gap-4 p-4 rounded-xl bg-accent/30 ${isRTL ? "flex-row-reverse" : ""}`}>
                      ...
                      <div
                        className={`flex items-center justify-between gap-4 p-4 rounded-xl bg-accent/30 cursor-pointer hover:bg-accent/50 transition-colors ${isRTL ? "flex-row-reverse" : ""}`}
                      ...
                      >
                        ...
                        <div
                          className={`w-12 h-7 rounded-full flex items-center px-1 transition-colors ${
                            preferences.analytics ? "bg-primary/20 justify-end" : "bg-muted justify-start"
                          }`}
                        >
                          <div
                      ...
                      >
                        ...
                        <div
                          className={`w-12 h-7 rounded-full flex items-center px-1 transition-colors ${
                            preferences.marketing ? "bg-primary/20 justify-end" : "bg-muted justify-start"
                          }`}
                        >
                          <div
                            className={`w-5 h-5 rounded-full flex items-center justify-center transition-colors ${
              ...
              <div className={`flex flex-col sm:flex-row gap-3 mt-6 ${isRTL ? "sm:flex-row-reverse" : ""}`}>
                <Button
                ...
                <Button
                  ...
                  className={`flex-1 gap-2 ${isRTL ? "font-arabic flex-row-reverse" : ""}`}
