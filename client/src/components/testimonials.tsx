...
const fallbackTestimonials = [
  {
    ...
    textEn: "iThing transformed our data infrastructure completely. Their AI solutions increased our operational efficiency by 40%. Highly recommend their expertise.",
    textAr: "غيّرت iThing بنيتنا التحتية للبيانات بالكامل. زادت حلول الذكاء الاصطناعي من كفاءتنا التشغيلية بنسبة 40%. أوصي بشدة بخبرتهم.",
    rating: 5,
  },
  {
    id: 2,
    ...
    textEn: "The custom healthcare solution they built for us streamlined our patient management system. Their team understood our needs perfectly.",
    textAr: "الحل الصحي المخصص الذي بنوه لنا سهّل نظام إدارة المرضى لدينا. فهم فريقهم احتياجاتنا تماماً.",
    rating: 5,
  },
  {
    id: 3,
    ...
    textEn: "Their IoT solutions revolutionized our supply chain tracking. Real-time monitoring saved us millions in operational costs.",
    textAr: "أحدثت حلول إنترنت الأشياء ثورة في تتبع سلسلة التوريد لدينا. وفرت المراقبة في الوقت الفعلي ملايين في تكاليف التشغيل.",
    rating: 5,
  },
];
