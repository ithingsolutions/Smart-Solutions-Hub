...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className={`fixed bottom-6 z-50 flex h-[500px] w-[380px] flex-col rounded-lg border bg-background shadow-2xl ${
            language === "ar" ? "left-6" : "right-6"
          }`}
          dir={language === "ar" ? "rtl" : "ltr"}
        >
          <div className="flex items-center justify-between gap-2 border-b bg-primary p-4 rounded-t-lg">
